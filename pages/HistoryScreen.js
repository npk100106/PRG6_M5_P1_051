...
/*const initialHistory = [
    { id: "1", course: "Web Programing", date: "2026-03-01", status: "Absent", room: "Lab 3", lecturer: "Bpk. Andi" },
...
export default function HistoryScreen({ navigation }) {
    ...
    // Panggil saat layer pertama kali dibuka
    useEffect(() => {
    ...
    const renderItem = ({ item }) => (
        // SIHIR NAVIGASI: Pindah layer sambil melempar parameter 'item'
        <TouchableOpacity
            style={styles.item}
    ...
    const renderFooter = () => {
        ...
        return (
            <View style={styles.footerLoader}>
                <ActivityIndicator size="small" color="#0B56A0" />
